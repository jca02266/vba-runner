...
| ❌ | MidB / Mid$ / MidB$ Statement | §5.4.3.5 |
...
| ❌ | Option Compare | §5.2.1.1 |
| ❌ | Option Base | §5.2.1.2 |
| ❌ | Option Private Module | §5.2.1.4 |
| ❌ | Attributes (VB_Name, etc.) | §5.2.3.1.6 / §5.2.4.1 |
| ✅ | Date Literals (#mm/dd/yyyy#) | §3.3.3.3 |
...
| 状態 | 関数/サブプロシージャ | 仕様書 |
|------|----------------|--------|
| ❌ | CurDir / CurDir$ | §6.1.2.5.1.1 |
| ❌ | Dir | §6.1.2.5.1.2 |
| ❌ | EOF | §6.1.2.5.1.3 |
| ❌ | FileAttr | §6.1.2.5.1.4 |
| ❌ | FileDateTime | §6.1.2.5.1.5 |
| ❌ | FileLen | §6.1.2.5.1.6 |
| ❌ | FreeFile | §6.1.2.5.1.7 |
| ❌ | Loc | §6.1.2.5.1.8 |
| ❌ | LOF | §6.1.2.5.1.9 |
| ❌ | Seek | §6.1.2.5.1.10 |
| ❌ | ChDir | §6.1.2.5.2.1 |
| ❌ | ChDrive | §6.1.2.5.2.2 |
| ❌ | FileCopy | §6.1.2.5.2.3 |
| ❌ | Kill | §6.1.2.5.2.4 |
| ❌ | MkDir | §6.1.2.5.2.5 |
| ❌ | RmDir | §6.1.2.5.2.6 |
| ❌ | SetAttr | §6.1.2.5.2.7 |
