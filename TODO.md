...
- [x] `scripts/bg-test.sh` を実行し、TypeScript/VBAテストの成功・失敗・未実施件数と所要時間を記録する（初回: 333/333、14/14、111/111、未実施0、約2分。共通化後の再実行: 333/333、14/14、111/111、未実施0、約8分。XL-016修正後の再実行: 333/333、14/14、111/111、未実施0、約7分。数値リテラル共通化後の最終再実行: 333/333、14/14、111/111、未実施0、約7分。途中の評価件数固定値の失敗は`8c61f35`および`3bef0d6`で修正。修正前の未使用import失敗は`64db649`で修正）
