...
powershell -NoProfile -ExecutionPolicy Bypass -File .\run-excel-queue.ps1 -Workbook "%~dp0t.xlsm" -Procedure RunExcelQueueVerification -Module ExcelQueueVerification
endlocal
