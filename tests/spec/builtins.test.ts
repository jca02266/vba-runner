...
// 1. String Functions
{
    ...
    assert.strictEqual(evalExpr('LeftB("abc", 1.6)'), 'a',
        'LeftB rounds fractional byte Length arguments');
    assert.strictEqual(evalExpr('RightB("abc", 1.6)'), 'c',
...
// Bug 321: numeric formatting option Null must be Error 94, not Type mismatch.
{
    ...
    assert.throwsMatch(() => ev.evalExpression('Format(#2024-01-01#, "ww", Null)'), /error '94'/,
