...
const matrixEv = evalVBASingle(`
    Function RoundTripMatrix() As String
        ...
        Get #1, , readBack
        Close #1
        RoundTripMatrix = RoundTripMatrix & ":" & CStr(raw(0)) & ":" & CStr(raw(1)) & ":" & CStr(raw(2)) & ":" & CStr(raw(3))
...
assert.strictEqual(matrixEv.callProcedure('RoundTripMatrix', []), '4:1:3:2:4:1:2:3:4');
