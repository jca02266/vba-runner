...
// VBA error line (within Sub body): 2
{
    try {
      ...
      End Sub
    `, '__test__', 20, /array or user-defined type|type mismatch/i, 'mirr_requires_array_argument');
        console.log('[PASS] mirr_requires_array_argument');
        __pass__++;
    } catch (e: any) {
        console.error('[FAIL] mirr_requires_array_argument:', e.message);
        __fail__++;
    }
}

// [preproc] mirr_requires_double_array_argument
// VBA: コンパイル エラー: 型が一致しません: 配列またはユーザー定義型を指定してください。
// VBA error line (within Sub body): 3
{
    try {
      ...
      End Sub
    `, '__test__', 21, /array or user-defined type|type mismatch/i, 'mirr_requires_double_array_argument');
        console.log('[PASS] mirr_requires_double_array_argument');
        __pass__++;
    } catch (e: any) {
        console.error('[FAIL] mirr_requires_double_array_argument:', e.message);
        __fail__++;
    }
}

// [preproc] mirr_integer_array_argument
// VBA: コンパイル エラー: 型が一致しません: 配列またはユーザー定義型を指定してください。
// VBA error line (within Sub body): 3
{
    try {
      ...
      Sub __test__()
        ...
        value = MIRR(flows, 0.1, 0.12)
      End Sub
    `, '__test__', 21, /array or user-defined type|type mismatch/i, 'mirr_integer_array_argument');
        console.log('[PASS] mirr_integer_array_argument');
        __pass__++;
    } catch (e: any) {
        console.error('[FAIL] mirr_integer_array_argument:', e.message);
        __fail__++;
    }
}

// [preproc] mirr_long_array_argument
// VBA: コンパイル エラー: 型が一致しません: 配列またはユーザー定義型を指定してください。
// VBA error line (within Sub body): 3
{
    try {
      ...
      Sub __test__()
        ...
        value = MIRR(flows, 0.1, 0.12)
      End Sub
    `, '__test__', 21, /array or user-defined type|type mismatch/i, 'mirr_long_array_argument');
        console.log('[PASS] mirr_long_array_argument');
        __pass__++;
    } catch (e: any) {
        console.error('[FAIL] mirr_long_array_argument:', e.message);
        __fail__++;
    }
}
...
// [preproc] mirr_variant_array_argument
// VBA: コンパイル エラー: 型が一致しません: 配列またはユーザー定義型を指定してください。
// VBA error line (within Sub body): 3
{
    try {
      ...
      Sub __test__()
        ...
        value = MIRR(flows, 0.1, 0.12)
      End Sub
    `, '__test__', 21, /array or user-defined type|type mismatch/i, 'mirr_variant_array_argument');
        console.log('[PASS] mirr_variant_array_argument');
        __pass__++;
    } catch (e: any) {
        console.error('[FAIL] mirr_variant_array_argument:', e.message);
        __fail__++;
    }
}

// [preproc] mirr_variant_value_array_argument
// VBA: コンパイル エラー: 型が一致しません: 配列またはユーザー定義型を指定してください。
// VBA error line (within Sub body): 3
{
    try {
      ...
      Sub __test__()
        ...
        value = MIRR(flows, 0.1, 0.12)
      End Sub
    `, '__test__', 21, /array or user-defined type|type mismatch/i, 'mirr_variant_value_array_argument');
        console.log('[PASS] mirr_variant_value_array_argument');
        __pass__++;
    } catch (e: any) {
        console.error('[FAIL] mirr_variant_value_array_argument:', e.message);
        __fail__++;
    }
}
...
// VBA error line (within Sub body): 2
{
    try {
      ...
      End Sub
    `, '__test__', 20, /qualified UDT|public object module|user-defined type|array or user-defined type/i, 'qualified_udt_array_declaration');
...
// [preproc] collection_item_without_required_argument
// VBA: コンパイル エラー: 引数は省略できません。
// VBA error line (within Sub body): 5
{
    try {
        assertCompileErrorPreproc(`
      Private Sub MySub()
    ...
    `, 'Case_collection_item_without_required_argument', 22, /argument not optional/i, 'collection_item_without_required_argument');
        ...
        console.error('[FAIL] collection_item_without_required_argument:', e.message);
        __fail__++;
    }
}

// [preproc] collection_item_without_required_argument_parens
// VBA: コンパイル エラー: 引数は省略できません。
// VBA error line (within Sub body): 5
{
    try {
    ...
    `, 'Case_collection_item_without_required_argument_parens', 22, /argument not optional/i, 'collection_item_without_required_argument_parens');
        ...
        console.error('[FAIL] collection_item_without_required_argument_parens:', e.message);
        __fail__++;
    }
}
