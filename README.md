...
./node_modules/.bin/tsx tests/spec/mid-variants.test.ts
```
...
```bash
# tsx で直接実行
./node_modules/.bin/tsx test-libs/vba-test-generator.ts tests/spec/vba/CurrencyOperationsTest.bas tests/spec/vba/CurrencyOperationsTest_runner.bas

# モジュール修飾なし
./node_modules/.bin/tsx test-libs/vba-test-generator.ts tests/spec/vba/CurrencyOperationsTest.bas tests/spec/vba/CurrencyOperationsTest_runner.bas --no-module-qualifier
```
