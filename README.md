...
| Improve legacy VBA with AI | [Hands-on tutorial](./docs/guides/TUTORIAL.md) |
...
| [REFERENCE.md](./docs/implementation/REFERENCE.md) | Detailed specs (sandbox, types, mocks, etc.) |
