...
|---|---|---|---:|---|
| EV-00100 | LEGACY | verified-no-bug |  | 実Excel照合 #100: バイナリ配列の物理レイアウト |
| EV-00101 | LEGACY | fixed |  | 実行互換性 #101: UDT内可変長String |
| EV-00102 | LEGACY | verified-no-bug |  | 実Excel照合 #102: UDT内可変長String |
| EV-00103 | LEGACY | verified-no-bug |  | 回帰確認 #103: EVAL_LOG既知項目の現状整合 |
| EV-00104 | LEGACY | verified-no-bug |  | 回帰確認 #104: LSP Introduce Variable |
| EV-00105 | LEGACY | known-limit |  | 回帰確認 #105: 拡張機能LSPリファクタリング群 |
| EV-00106 | LEGACY | fixed |  | 回帰確認 #106: LSP CodeLens・Hover・TestRunner |
| EV-00107 | LEGACY | fixed |  | 実行互換性 #107: VFSファイル属性 |
| EV-00108 | LEGACY | fixed |  | 実行互換性 #108: ケースインセンシティブな宣言重複 |
| EV-00109 | LEGACY | verified-no-bug |  | テスト基盤 #109: VBARunner共有VFS |
| EV-00110 | LEGACY | fixed |  | 回帰確認 #110: Tier 6 名前空間分離 |
| EV-00111 | LEGACY | fixed |  | リファクタリング確認 #111: precheckProc一括走査 |
| EV-00112 | LEGACY | verified-no-bug |  | Lexer分類確認 #112: 識別子カテゴリメタデータ |
| EV-00113 | LEGACY | fixed |  | 実行互換性 #113: WithEvents の ByRef イベント引数 |
| EV-00114 | LEGACY | fixed |  | 実行互換性 #114: ByVal Variant 配列のコピー境界 |
| EV-00115 | LEGACY | fixed |  | 実行互換性 #115: 括弧付きByRef配列引数と非ゼロ下限 |
| EV-00116 | LEGACY | fixed |  | 言語仕様 #116: ParamArray 宣言制約 |
| EV-00117 | LEGACY | fixed |  | 実行互換性 #117: FileSystemObject のファイル移動・コピー |
| EV-00118 | LEGACY | fixed |  | 実行互換性 #118: FileSystemObject TextStream の読み取り境界 |
| EV-00119 | LEGACY | verified-no-bug |  | 回帰確認 #119: Property・Binary・ファイルモード境界 |
| EV-00120 | LEGACY | verified-no-bug |  | 仕様確認 #120: Format数値書式の色指定 |
| EV-00121 | LEGACY | verified-no-bug |  | 回帰確認 #121: 引数束縛とネストしたエラー伝播 |
| EV-00122 | LEGACY | verified-no-bug |  | 記録整合確認 #122: 重点候補の実施状況 |
| EV-00123 | LEGACY | fixed |  | 実行互換性 #123: FSO TextStream Unicode入出力 |
| EV-00124 | LEGACY | fixed |  | 回帰修正 #124: カバレッジ検出3件 |
| EV-00125 | LEGACY | fixed |  | 実行互換性 #125: ネストUDTの値コピー |
| EV-00126 | LEGACY | fixed |  | 仕様確認 #126: Format条件セクション・Declare引数検査 |
| EV-00127 | LEGACY | verified-no-bug |  | 実Excel照合 #127: FSO・ネストUDT |
| EV-00128 | LEGACY | fixed |  | 文法評価 #128: 生成ケースと演算子境界 |
| EV-00129 | LEGACY | verified-no-bug |  | テスト強度評価 #129: ミューテーションテスト |
| EV-00130 | LEGACY | fixed |  | 文法評価 #130: 宣言型サフィックス付き引数 |
| EV-00131 | FZ-GRAMMAR | fixed |  | 実行互換性 #131: クラス配列要素のByRef書き戻し |
| EV-00132 | LEGACY | fixed |  | 実行互換性 #132: Property Set のByRefオブジェクト引数 |
| EV-00133 | LEGACY | verified-no-bug |  | リファクタリング確認 #133: 引数束縛経路の共通化 |
| EV-00134 | LEGACY | verified-no-bug |  | リファクタリング確認 #134: ByRef書き戻し参照の共通化 |
| EV-00135 | LEGACY | verified-no-bug |  | リファクタリング確認 #135: ParamArray書き戻し参照の共通化 |
| EV-00136 | LEGACY | verified-no-bug |  | リファクタリング確認 #136: l-value読み取り・書き戻しの共通化 |
| EV-00137 | LEGACY | verified-no-bug |  | リファクタリング確認 #137: Property/Event・組み合わせ経路の統合 |
| EV-00138 | LEGACY | verified-no-bug |  | 全テスト・カバレッジ確認 #138 |
| EV-00139 | LEGACY | verified-no-bug |  | 回帰修正 #139: Longサフィックス後の連結演算子 |
| EV-00140 | LEGACY | fixed |  | 実行互換性 #140: Property Let ByRef書き戻し |
| EV-00141 | LEGACY | fixed |  | リファクタリング強化 #141: Property代入経路の参照伝播 |
| EV-00142 | LEGACY | verified-no-bug |  | 回帰確認 #142: Property特殊経路テスト追加 |
| EV-00143 | FZ-BUILTIN | verified-no-bug |  | 実行互換性 #143: FormatPercent の表示オプション |
| EV-00144 | FZ-BUILTIN | verified-no-bug |  | 回帰確認 #144: Null/Empty Variant配列境界 |
| EV-00145 | FZ-BUILTIN | verified-no-bug |  | 実行互換性 #145: Pmt のゼロ期間エラー |
| EV-00146 | FZ-BUILTIN | fixed |  | 実行互換性 #146: DateValue の不正日付 |
| EV-00147 | FZ-BUILTIN | verified-no-bug |  | 回帰確認 #147: Currency/Decimal/Boolean 型強制 |
| EV-00148 | FZ-BUILTIN | verified-no-bug |  | 実行互換性 #148: CStr の配列・Object 型強制 |
| EV-00149 | FZ-BUILTIN | verified-no-bug |  | 回帰確認 #149: ErrorValue と Null/Empty 混在演算 |
| EV-00150 | FZ-BUILTIN | verified-no-bug |  | 実行互換性 #150: CVErr の論理演算・文字列連結 |
| EV-00151 | FZ-GRAMMAR | fixed |  | 実行互換性 #151: 名前付きProperty LetのByRef境界 |
| EV-00152 | FZ-GRAMMAR | fixed |  | 実行互換性 #152: 修飾名前付きByRef引数 |
| EV-00153 | FZ-GRAMMAR | fixed |  | 実行互換性 #153: ローカル2次元クラス配列のPreserve |
| EV-00154 | FZ-GRAMMAR | fixed |  | 実行互換性 #154: Property Getの2次元配列戻り値 |
| EV-00155 | FZ-BUILTIN | fixed |  | 実行互換性 #155: 既定ValueオブジェクトのCStr |
| EV-00156 | FZ-BUILTIN | fixed |  | 実行互換性 #156: 既定ValueのBoolean・数値型強制 |
| EV-00157 | FZ-BUILTIN | fixed |  | 実行互換性 #157: IsNumericの既定Value判定 |
| EV-00158 | FZ-BUILTIN | fixed |  | 実行互換性 #158: IsDate/CDateの既定Value判定 |
| EV-00159 | LEGACY | verified-no-bug |  | 実行互換性 #159: DateValueの既定Value判定 |
| EV-00160 | FZ-BUILTIN | verified-no-bug |  | 回帰確認 #160: Err.Raise伝播とDecimal overflow後のErr状態 |
| EV-00161 | FZ-GRAMMAR | verified-no-bug |  | 回帰確認 #161: 型付き多次元配列のPreserve追加シード |
| EV-00162 | FZ-GRAMMAR | verified-no-bug |  | 回帰確認 #162: 宣言型サフィックスの比較・連結 |
| EV-00163 | MUT-ENGINE | verified-no-bug |  | 回帰確認 #163: UDT Binary Put/Get 境界変異 |
| EV-00164 | FZ-BUILTIN | fixed |  | 実行互換性 #164: 日付関数の既定Value展開 |
| EV-00165 | LEGACY | verified-no-bug |  | 実行互換性 #165: Formatの既定Value展開 |
| EV-00166 | FZ-GRAMMAR | verified-no-bug |  | 回帰確認 #166: 直接手続きの名前付きByRef引数 |
| EV-00167 | FZ-GRAMMAR | fixed |  | 実行互換性 #167: CallByNameのクラスByRef書き戻し |
| EV-00168 | MUT-ENGINE | fixed |  | 実行互換性 #168: 標準ファイルI/OのCP932文字列 |
| EV-00169 | MUT-ENGINE | fixed |  | 実行互換性 #169: Inputの行境界跨ぎ |
| EV-00170 | MUT-ENGINE | fixed |  | 実行互換性 #170: EOF後のLine Inputエラー |
| EV-00171 | FZ-BUILTIN | fixed |  | 実行互換性 #171: Currency/Decimalの型強制・日付シリアル |
| EV-00172 | LEGACY | fixed |  | 実行互換性 #172: 循環既定Valueの安全な拒否 |
| EV-00173 | MUT-ENGINE | fixed |  | 実行互換性 #173: Select Caseの日付値比較 |
| EV-00174 | MUT-ENGINE | verified-no-bug |  | 回帰確認 #174: Select Case追加数値種別 |
| EV-00175 | FZ-GRAMMAR | fixed |  | 実行互換性 #175: 外部CallByNameのメンバー解決 |
| EV-00176 | MUT-ENGINE | fixed |  | 実行互換性 #176: Inputの不足フィールドEOF |
| EV-00177 | FZ-GRAMMAR | verified-no-bug |  | 回帰確認 #177: 外部CallByNameの引数境界 |
| EV-00178 | FZ-BUILTIN | fixed |  | 実行互換性 #178: 既定Value Nullの数値書式 |
| EV-00179 | MUT-ENGINE | fixed |  | 実行互換性 #179: InputのEmptyフィールドと空ファイルEOF |
| EV-00180 | FZ-GRAMMAR | fixed |  | 16進・8進リテラルの符号とサフィックス |
| EV-00181 | MUT-ENGINE | fixed |  | On Error Resume NextのErr.Source更新 |
| EV-00182 | MUT-ENGINE | fixed |  | FSO追記とクラスByVal引数の相互作用 |
| EV-00183 | FZ-GRAMMAR | fixed |  | LongLong/LongPtrリテラルの64ビット境界 |
| EV-00184 | MUT-ENGINE | fixed |  | Select CaseのLongLong比較と呼出し経路横展開 |
| EV-00185 | FZ-BUILTIN | fixed |  | Null既定Valueの型変換エラー |
| EV-00186 | FZ-BUILTIN | verified-no-bug |  | 既定Value日付の境界引数 |
| EV-00187 | MUT-ENGINE | verified-no-bug |  | Append/Inputの混在ハンドル境界 |
...
| EV-00233 | FZ-BUILTIN | fixed | 1 | Lock/Unlockの小数・逆順範囲と逐次モードError 70 |
...
| EV-00262 | FZ-BUILTIN | verified-no-bug |  | 情報関数のVariant境界 |
...
| EV-00378 | FZ-BUILTIN | verified-no-bug |  | TimeSerial負数コンポーネントの正規化 |
| EV-00379 | FZ-BUILTIN | fixed |  | CallByNameと通常代入のProperty Let/Set種別境界 |
...
| EV-00385 | FZ-GRAMMAR | fixed | 0 | クラスメンバーParamArray呼出し境界 |
| EV-00386 | FZ-GRAMMAR | verified-no-bug | 0 | With入れ子と既定メンバー解決境界 |
| EV-00387 | MUT-ENGINE | verified-no-bug | 0 | Optional・ByRef・名前付き引数の混在バインド |
| EV-00388 | MUT-ENGINE | fixed | 0 | 配列戻り値とByRef配列の境界 |
| EV-00389 | MUT-ENGINE | fixed | 0 | 配列全体代入のメンバー境界 |
| EV-00390 | MUT-ENGINE | fixed | 1 | Setによる配列参照境界 |
| EV-00391 | MUT-ENGINE | fixed | 0 | メンバー配列右辺の全体代入境界 |
| EV-00392 | MUT-ENGINE | fixed | 0 | ネストProperty Get配列戻り値の境界 |
| EV-00393 | MUT-ENGINE | fixed | 0 | With経由Property Get配列戻り値の境界 |
| EV-00394 | MUT-ENGINE | fixed | 0 | 配列getter判定の評価回数 |
| EV-00395 | MUT-ENGINE | verified-no-bug | 0 | 動的型配列getter戻り値の受け渡し |
| EV-00396 | MUT-ENGINE | verified-no-bug | 0 | COM mock SAFEARRAY getter境界 |
...
| EV-00419 | RCA-FOLLOWUP | fixed | 1 | FSO TextStreamのClose後Read/Write契約 |
...
| EV-00422 | RCA-FOLLOWUP | fixed | 1 | 実COM StreamのClose後エラー番号 |
| EV-00423 | RCA-FOLLOWUP | fixed | 1 | TextStream EOF ReadLine境界 |
...
| EV-00454 | FZ-COVERAGE-20260810 | verified-no-bug | 1 | Class・標準手続き間のOn Error状態とErr復帰 |
...
| EV-00574 | FZ-COVERAGE-20260810 | verified-no-bug | 1 | コレクション・Dictionary領域のDictionary列挙・外部Object列挙・Bang回帰 |
| EV-00575 | FZ-COVERAGE-20260810 | verified-no-bug | 1 | コレクション・Dictionary領域のObject要素列挙・解放・再利用回帰 |
...
| EV-00587 | FZ-COVERAGE-20260810 | verified-no-bug | 1 | LSP・拡張機能領域のDebugger・Test Runner・Debug Hook境界回帰 |
...
| EV-00750 | FZ-COVERAGE-20260810 | fixed | 1 | Format連続カンマと負数・ゼロ・小数・百分率・複数セクションの境界 |
...
| EV-00770 | FZ-COVERAGE-20260810 | in-progress | 1 | Format Currency・Decimal・LongLongの指数書式と末尾カンマの型別経路 |
...
| EV-00777 | FZ-COVERAGE-20260810 | in-progress | 1 | Formatの空ブラケット・降順範囲・不正ブラケットのトークン検証境界 |
| EV-00778 | FZ-COVERAGE-20260810 | in-progress | 1 | Format単独の@・&・!プレースホルダーと数値・文字列型の適用境界 |
| EV-00779 | FZ-COVERAGE-20260810 | in-progress | 1 | Format文字列プレースホルダーの長さ・空文字・Unicode充填境界 |
...
| EV-00783 | FZ-COVERAGE-20260810 | in-progress | 1 | Format文字列の引用符・バックスラッシュによるリテラル境界 |
...
| EV-00804 | ROOT-CAUSE | in-progress |  | MIRR別キャッシュフロー判定のv2再評価 |
