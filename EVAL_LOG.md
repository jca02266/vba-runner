...
| EV-00601 | FZ-COVERAGE-20260810 | queued | 1 | 宣言・型・リテラル領域の基数変換符号拡張と変換先型回帰 |
...
横展開未解決経路: 446、実Excel待ち評価: 0

## 次の候補

| ID | 優先度 | 実効状態 | 対象 | coverage一致 |
|---|---:|---|---|---|
| FZ-COVERAGE-20260810-154 | 1 | queued | 宣言・型・リテラル領域の基数変換符号拡張と変換先型回帰 | yes |
