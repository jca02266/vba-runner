...
| EV-01003 | FZ-COVERAGE-20260823 | fixed |  | Event宣言とRaiseEventの引数個数不一致 |
| EV-01004 | FZ-COVERAGE-20260823 | fixed |  | WithEventsハンドラーのByRef・型署名不一致 |
...
| EV-01007 | FZ-COVERAGE-20260823 | fixed |  | 別標準モジュールPrivate SubのWithEvents誤配線 |
